...
fun main(args: Array<String>): Unit = runBlocking {
    ...
    val configFile by parser.option(ArgType.String, "config", "c", description = "The config file to use").required()
    val clientId by parser.option(ArgType.String, "clientId", "id", description = "The client id").required()
    val clientSecret by parser.option(ArgType.String, "clientSecret", "sec", description = "The client secret").required()
    parser.parse(args)
    ...
    val token = TokenManager.getToken(clientId, clientSecret)
    val api = TokenManager.buildApi(clientId, clientSecret, token)
